...
class Gui(object):
    def setupUi(self, MainWindow):
        ...
        self.userFollowListWidget = QtWidgets.QListWidget(self.verticalLayoutWidget_2)
        self.userFollowListWidget.setObjectName("userFollowListWidget")
        self.gridLayout.addWidget(self.userFollowListWidget, 3, 1, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout)
        self.changeFollowComboBox = QtWidgets.QComboBox(self.verticalLayoutWidget_2)
        self.changeFollowComboBox.setObjectName("changeFollowComboBox")
        self.verticalLayout_2.addWidget(self.changeFollowComboBox)
        self.followButton = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.followButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.followButton.setObjectName("followButton")
        self.verticalLayout_2.addWidget(self.followButton)
        self.unfollowButton = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.unfollowButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.unfollowButton.setObjectName("unfollowButton")
        self.verticalLayout_2.addWidget(self.unfollowButton)
        ...
        self.pageAdminsListWidget = QtWidgets.QListWidget(self.verticalLayoutWidget_4)
        self.pageAdminsListWidget.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.pageAdminsListWidget.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.pageAdminsListWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.pageAdminsListWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.pageAdminsListWidget.setItemAlignment(QtCore.Qt.AlignLeading)
        self.pageAdminsListWidget.setObjectName("pageAdminsListWidget")
        self.gridLayout_2.addWidget(self.pageAdminsListWidget, 1, 1, 1, 1)
        self.verticalLayout_6.addLayout(self.gridLayout_2)
        self.changeAdminBox = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.changeAdminBox.setObjectName("changeAdminBox")
        self.verticalLayout_6.addWidget(self.changeAdminBox)
        ...
        self.removeAdminButton = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.removeAdminButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.removeAdminButton.setObjectName("removeAdminButton")
        self.verticalLayout_6.addWidget(self.removeAdminButton)
        ...
        self.arcsView = QtWidgets.QTableWidget(self.viewTab)
        ...
        self.arcsView.setColumnCount(2)
        self.arcsView.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.arcsView.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.arcsView.setHorizontalHeaderItem(1, item)
        self.arcsView.horizontalHeader().setVisible(False)
        self.sommetsView = QtWidgets.QTableWidget(self.viewTab)
        ...
        self.sommetsView.setColumnCount(3)
        self.sommetsView.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.sommetsView.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sommetsView.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.sommetsView.setHorizontalHeaderItem(2, item)
        self.sommetsView.horizontalHeader().setVisible(False)
        ...
        MainWindow.setTabOrder(self.pageInfosSelected, self.pageAdminsListWidget)
        MainWindow.setTabOrder(self.pageAdminsListWidget, self.changeAdminBox)
        MainWindow.setTabOrder(self.changeAdminBox, self.addAdminButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.followButton.setText(_translate("MainWindow", "Suivre"))
        self.unfollowButton.setText(_translate("MainWindow", "Ne plus suivre"))
        self.deleteUserButton.setText(_translate("MainWindow", "Supprimer l\'utilisateur [FIX]"))
        ...
        self.removeAdminButton.setText(_translate("MainWindow", "Supprimer un administrateur"))
        self.deletePageButton.setText(_translate("MainWindow", "Supprimer la page [FIX]"))
        ...
        item = self.arcsView.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "from"))
        item = self.arcsView.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "to"))
        item = self.sommetsView.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "name"))
        item = self.sommetsView.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "firstName"))
        item = self.sommetsView.horizontalHeaderItem(2)
